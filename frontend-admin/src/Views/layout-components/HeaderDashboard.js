...
<>
          ...
          {websiteDetails.title}
                  ...
                  <li className="nav-item">
                    ...
                    <li className="nav-item">
							<a className="nav-link" href="/admin/predictions"><i className="fa fa-star sidemenu-icon"></i><span className="sidemenu-label">Predictions</span></a> 
										</li>
						<li className="nav-item">
						...
						<li className="nav-item">
							<a className="nav-link" href="/admin/bookings"><i className="fa fa-futbol-o sidemenu-icon"></i><span className="sidemenu-label">Booking Codes</span> &nbsp;&nbsp;&nbsp;&nbsp;</a>
						</li>
						<li className="nav-item">

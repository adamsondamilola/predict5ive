...
const Announcements = () => {
    ...
    const deviceGroups = () => {      
      fetch(process.env.REACT_APP_MAIN_API +'admin/announcement/groups', options)
                   ...
                   <div class="col-lg-12">
                     <div class="contact-form">
                             <div class="row">
                                 ...
                                 <div class="col-12">
                                     <div class="form-group">
                                     <select className='form-control' onChange={e => setBatchNumber(e.target.value)}>
    <option value={0}>Post to App</option>
    {batches.map(bt =>
    <option value={bt.batch_number}>Post to Group {bt.batch_number}</option>
               )}

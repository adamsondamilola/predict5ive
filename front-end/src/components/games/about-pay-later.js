...
const AboutPayLaterSub = () => {
  ...
  const [phone, setPhone] = useState("2348123456789");
    ...
    const premiumPlans = [
        {package: "1", package_name: "Pay later subscription", amount: "2000"}
    ]
                    ...
                    <div className="bg-white dark:bg-gray-800 dark:text-white">
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2 dark:text-white" htmlFor="username">
                                Pay Later Subscription
                            </label>
                            {/*<img src={Images.betting} />*/}
                        </div>
                        <div className="mb-4">
                        This is for hight stakers who are ready to make at least 4 times return on their capital weekly.
                        </div>
                       
                        <div className="mb-4">
                        For more information, kindly write to us info@predict5ive.com
                        </div>
...
export default AboutPayLaterSub
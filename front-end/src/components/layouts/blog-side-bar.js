...
<div className="w-full bg-white dark:bg-gray-800 dark:text-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <p className="text-xl font-semibold pb-5">Booking Codes 
    ...
    <div className="w-full bg-white dark:bg-gray-800 dark:text-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <p>
            <a href="https://play.google.com/store/apps/details?id=com.cpromoter.predict5ive">
            <img src={"https://play-lh.googleusercontent.com/M-3SNcYitOiujSJo0WjGLt95jI8oZbvqPfSMn4n-NUTD1ElYCc1I68wq75Eh5qCRC7Q=w480-h960-rw"} 
                alt="App Image"
    ...
    <div className="w-full bg-white dark:bg-gray-800 dark:text-white shadow flex flex-col my-4 p-6">
        <p className="text-xl font-semibold pb-5">Recent Posts</p>
        {blogpost.map((post)=> (
